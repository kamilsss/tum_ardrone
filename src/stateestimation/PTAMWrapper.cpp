...
void PTAMWrapper::HandleFrame()
{
	...
	if(node->logfilePTAM != NULL)
	{
		...
		if(node->logfilePTAM != NULL)
			...
			<< filterPosePrePTAM[0] << " " << filterPosePrePTAM[1] << " " << filterPosePrePTAM[2] << " " // x, y. z  - 2,3,4
			<< filterPosePrePTAM[3] << " " << filterPosePrePTAM[4] << " " << filterPosePrePTAM[5] << " " // r, p, y  - 5,6,7
			<< filterPosePrePTAM[6] << " " << filterPosePrePTAM[7] << " " << filterPosePrePTAM[8] << " " // 8,9,10
			<< filterPosePrePTAM[9] << " "	// 11
			<< filterPosePostPTAM[0] << " " << filterPosePostPTAM[1] << " " << filterPosePostPTAM[2] << " "  //12, 13, 14
